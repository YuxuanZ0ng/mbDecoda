...
n.taxa = 100; balanced.micro.load = FALSE; balanced.lib.size = TRUE 
samp.frac = "large"; n.samp = c("15_15")
...
for (j in 1:iterNum) {
  ...
  DATA[[j]]=abn.tab.gen1(n.taxa, n.samp.grp1, n.samp.grp2, low.abn, med.abn, high.abn,
                         prop.diff, abn.seed, obs.seed, struc.zero.prop, out.zero.prop,
                         balanced.micro.load, balanced.lib.size, samp.frac)
}


saveRDS(DATA,"DATA_ANCOMBC_sig0.1.RDS")
...
saveRDS(DATA,"DATA_ANCOMBC_sig0.2.RDS")

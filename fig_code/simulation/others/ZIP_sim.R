...
ZIP_sim=function(seed, K, n1, n2, p, bias=c("large", "small"),zi=0.5){
...
DATA=list()
for (i in 1:n.sim) {
  DATA[[i]]=ZIP_sim(seed=i,K=K,n1=n1,n2=n2,p=sig.prob,bias =bias,zi=0.3)
}
saveRDS(DATA, file = "DATA_ZIP_sig0.1.RDS")
...
saveRDS(DATA, file = "DATA_ZIP_sig0.2.RDS")
